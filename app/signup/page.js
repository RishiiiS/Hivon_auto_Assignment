...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-between bg-[#FCFBFA] font-sans selection:bg-blue-100 relative overflow-hidden absolute inset-0 z-50">
      ...
      <div className="flex-1 flex flex-col items-center justify-center w-full px-4 z-10 pt-10">
        ...
        <div className="w-full max-w-[440px] bg-white rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] p-8 md:p-10 border border-gray-100 relative">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500 font-medium">Join the curated world of The Editorial Archive.</p>
          </div>
          ...
          <form onSubmit={handleSignup} className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <input 
                ...
                required 
                className="w-full pb-3 text-sm border-b border-gray-200 focus:border-[#0A4BB5] focus:outline-none transition-colors placeholder:text-gray-300 bg-transparent rounded-none tracking-wide"
              />
            </div>
          ...
          <div className="mt-6 flex gap-3">
            <button type="button" className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-white border border-gray-200 rounded-md shadow-sm hover:bg-gray-50 transition-colors text-xs font-semibold text-gray-800">
        ...
        {/* Existing User Login Link underneath card */}
        <div className="z-10 mt-6 text-xs text-gray-500 font-medium pb-8 border-b-2 border-transparent">
          Already have an account? <a href="/login" className="text-[#0A4BB5] font-bold ml-1 hover:-translate-y-0.5 transition-transform inline-block">Sign in</a>
        </div>
