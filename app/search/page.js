...
export default function SearchPage() {
  ...
  return (
    <div className="space-y-6 flex flex-col items-center py-10 w-full max-w-4xl mx-auto">
      ...
      {loading && <p className="text-gray-500 animate-pulse mt-10">Searching the archives...</p>}
      {error && <p className="text-red-500 bg-red-50 p-4 rounded-md w-full text-center border border-red-200 mt-6">{error}</p>}
